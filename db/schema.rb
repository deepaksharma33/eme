...
ActiveRecord::Schema[7.0].define(version: 2023_07_25_125311) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.index ["excavator_id"], name: "index_companies_on_excavator_id"
  end
  ...
  create_table "datetimes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ticket_id"], name: "index_datetimes_on_ticket_id"
  end

  create_table "dig_site_infos", force: :cascade do |t|
    t.text "well_known_text"
    t.bigint "ticket_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["ticket_id"], name: "index_dig_site_infos_on_ticket_id"
  end
